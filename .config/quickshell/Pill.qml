...
Item {
    ...
    readonly property bool webOpen: surface === "web"
    readonly property bool settingsLike: settingsOpen
    ...
    /** Always empty on Niri (no special workspaces). */
    ...
    readonly property bool quickChoosing: false
    ...
    readonly property real webW: 400 * s
    ...
    readonly property var surfaces: ({
        ...
        web:       { size: () => Qt.size(webW, web.implicitHeight + 29 * s), ame: null }
    })
    ...
    Item {
        ...
        Row {
            ...
            Item {
                ...
                /** No music visualizer (Cava removed). Show clock glyph always. */
                readonly property bool barsOn: false
